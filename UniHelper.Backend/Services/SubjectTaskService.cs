...
/// <inheritdoc cref="Interfaces.ISubjectTaskService" />
public class SubjectTaskService : MapperRepository<SubjectTask, int>, ISubjectTaskService
{
    ...
    public List<TaskDto> GetMyList()
    {
        ...
        return user == -1 ? new List<TaskDto>() : GetMappedList<TaskDto>(x => x.Subject.Period.UserId == user).ToList();
    }
}
